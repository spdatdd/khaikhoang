...
array = ['bat-dong-san', 'doi-song', 'du-lich', 'giai-tri', 'giao-duc', 'khoa-hoc', 'kinh-doanh', 'so-hoa', 'suc-khoe', 'the-gioi', 'the-thao', 'thoi-su'] 
labelEncoder = LabelEncoder()
labelEncoder.fit(array)
labelEncoder.transform(array)
...
class ClassifierNewsModel(Resource):
...
api.add_resource(ClassifierNewsModel, '/classifier_news')
